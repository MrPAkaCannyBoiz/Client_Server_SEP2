...
public class ViewFactory
{
  ...
  private VehicleBookingView vehicleBookingView;
  ...
  public void getNewCustomerView()
  {
    ...
    try
    {
      //same window: use primary Stage
      Scene scene = new Scene(loader.load());
      primaryStage.setTitle("SEP2 VIACarRental new customer page");
      primaryStage.setScene(scene);
      primaryStage.show();
      loader.getController();
    }
  ...
  //only for test, mean to be deleted later
  public void getChooseCustomerViewAsNewPage()
  {
    FXMLLoader loader = new FXMLLoader(getClass().getResource("../View/ChooseCustomerView.fxml"));
    loader.setControllerFactory(parameter ->
    {
    ...
    try
    {
      Stage stage = new Stage();
      Scene scene = new Scene(loader.load());
      stage.setTitle("SEP2 VIACarRental choose exist customer page");
      stage.setScene(scene);
      stage.show();
      loader.getController();
    }
  ...
  public void getNewCustomerViewAsNewPage()
  {
    ...
    try
    {
      ...
      stage.setScene(scene);
      stage.show();
      NewCustomerView controller = loader.getController();
      controller.setButtonsDisabledForNewTab();
    }
    catch (IOException e)
    {
      throw new RuntimeException(e);
  ...
  //only for test, mean to be deleted later
  public void getEmployeePageViewAsNewPage()
  {
    FXMLLoader loader = new FXMLLoader(getClass().getResource("../View/EmployeePageView.fxml"));
    loader.setControllerFactory(parameter ->
    {
  ...
  //only for test, mean to be deleted later
  public void getCustomerPageViewAsNewPage()
  {
    FXMLLoader loader = new FXMLLoader(getClass().getResource("../View/CustomerPageView.fxml"));
    loader.setControllerFactory(parameter ->
    {
