...
public class ClientSocketHandler implements RemoteModel, PropertyChangeSubject
{
  ...
  @Override
  public void makeBookingByCustomer(LocalDate startDate, LocalDate endDate, Customer customer, Vehicle vehicle) {
  ...
  public void addCustomer(Customer customer) {
    sendCommand(new Server.Command.AddCustomerCommand(customer));
  }
